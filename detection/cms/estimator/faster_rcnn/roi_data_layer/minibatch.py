...
"""Compute minibatch blobs for training a Fast R-CNN .faster_rcnn.network."""
...
# <<<< obsolete
from detection.cms.estimator.faster_rcnn.utils.blob import prep_im_for_blob, im_list_to_blob
...
def _get_bbox_regression_labels(bbox_target_data, num_classes):
    ...
    by the .faster_rcnn.network (i.e. only one class has non-zero targets). The loss weights
