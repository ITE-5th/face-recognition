...
from detection.cms.estimator.faster_rcnn.utils.cython_bbox import bbox_overlaps
from detection.cms.estimator.faster_rcnn.utils.boxes_grid import get_boxes_grid

# TODO: make CMS.faster_rcnn.fast_rcnn irrelevant
# >>>> obsolete, because it depends on sth outside of this project
from ..fast_rcnn.config import cfg
from detection.cms.estimator.faster_rcnn.rpn_msr.generate_anchors import generate_anchors
# <<<< obsolete
...
class kitti(imdb):
    ...
    def region_proposal_roidb(self):
        ...
        if self._image_set != 'test':
            ...
            print('Loading region proposal .faster_rcnn. .faster_rcnn.network boxes...')
            ...
            print('Region proposal .faster_rcnn. .faster_rcnn.network boxes loaded')
