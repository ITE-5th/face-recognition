...
#   from detection.cms.estimators.faster_rcnn.fast_rcnn_config import cfg
cfg = __C
...
# region proposal .faster_rcnn. .faster_rcnn.network (RPN) or not
__C.IS_RPN = True
...
# We use the same pixel mean for all .faster_rcnn. .faster_rcnn.networks even though it's not exactly what
...
def get_output_dir(imdb, weights_filename):
    ...
    A canonical path is built using the name from an imdb and a .faster_rcnn. .faster_rcnn.network
    (if not None).
    """
