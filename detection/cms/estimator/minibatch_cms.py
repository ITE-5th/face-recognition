...
class CMSRCNN(nn.Module):
    ...
    def __init__(self):
        ...
        # The projection uses the 'spatial scale' which is the size ratio of the input
    ...
    def forward(self, im_data, im_info, gt_boxes=None, gt_ishard=None, dontcare_areas=None):
        ...
        if self.training:
            ...
            # gt_boxes ( count, 5 )
            # roi_data ( 5variables )
            roi_datas, rois = self.proposal_target_layer_forloop(rois, gt_boxes, gt_ishard, dontcare_areas,
                                                                 batch_size)
        ...
        if self.training:
            ...
            self.cross_entropy, self.loss_box = self.build_loss_forloop(cls_prob, bbox_pred, roi_datas)
    ...
    def project_into_feature_maps(feature_maps, rois, im_info):
        ...
        # center of the face
        face_center_x = bboxes[:, :, 1] + face_width * 0.5
        face_center_y = bboxes[:, :, 2] + face_height * 0.5
